...
echo "Get list of directories on ${CXCOMMERCE_HOME}/${CUSTOM_DIR}/${CUSTOM_MODULES_DIR}"
cd ${CXCOMMERCE_HOME}/${CUSTOM_DIR}/${CUSTOM_MODULES_DIR}
...
echo "Save the intersection between localextensions and directories on ${CXCOMMERCE_HOME}/${CUSTOM_DIR}/${CUSTOM_MODULES_DIR}"
